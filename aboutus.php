...
<html>
  ...
  <head>
    <title> About | Hotel Rasika' </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="liqourlist.php"><span class="glyphicon glyphicon-cutlery"></span> liqour zone </a></li>
...
?>
<div class="wide">
    <img src="hotel rasika.jpg" alt="Image description" style="width: 100%; height: auto;">
    ...
    <h3 style="color: red">About the liqour culture in Hotel Rasika'</h3>
    <!-- Rest of the code -->
</div>
...
<div class="wide">
    <img src="mocktail.jpg" alt="Image description" style="width: 100%; height: auto;">
    <div class="tagline">It's not our <font color="red"><strong>work life</strong></font>, it's our <font color="green"><strong><em>life's work</em>.</strong></font></div>
    <h3 style="color: red">About the liqour culture in Hotel Rasika'</h3>
    <!-- Rest of the code -->
</div>