...
<html>
  ...
  <head>
    <title> Contact | Hotel Rasika' </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Hotel Rasika' </span>?</strong>
     <br>
    ...
    <!-- Step 3: Create the verification form -->
...
function generateOTP()
{
    ...
    // Store the OTP in the database along with the user's email address
    
    return $otp;
}

// Step 2: Send the OTP to the user via email
...
function verifyOTP($email, $otp)
{
    ...
    // Compare the OTPs
    // If the OTPs match, mark the email address as verified in the database
}
