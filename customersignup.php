<html>
<head>
    <title> Guest Signup | Hotel Rasika' </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> Hotel Rasika' </span></h1>
     <br>
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <label style="margin-left: 10px;">or</label> <br>
       <label style="margin-left: 10px;"><a href="customerlogin.php">Have an account? Login.</a></label>
